...
The protected source and latest published release are **v0.34.34**. Release Please PR #1923 is
...
The v0.34.34 package is a metadata-only follow-up to v0.34.33 and carries its verified runtime evidence and the approved-answer-term
...
contracts. The installed v0.34.34 binary passed the deterministic offline fixture evaluation and
...
package for your operating system and CPU. The current verified release is **v0.34.34**; its
...
The v0.34.34 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.34.34 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
