...
The protected source and latest published release are **v0.34.12**. Release-assets workflow
`32552400854` completed the platform-package and strict 18-asset verification gate. The v0.34.12
...
package for your operating system and CPU. The current protected release is **v0.34.12**. Its
...
The v0.34.12 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.34.12 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
