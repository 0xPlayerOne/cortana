...
package for your operating system and CPU. The current protected release is **v0.32.12**. Its
...
The v0.32.12 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.32.12 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
