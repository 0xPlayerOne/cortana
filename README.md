...
The protected source and latest published release are **v0.32.10**. Release-assets workflow
`31926397636` completed all platform packages and the strict 18-asset verifier, including
checksums, updater signatures, the manifest, and packaged-core evaluation. The v0.32.10
...
package for your operating system and CPU. The current protected release is **v0.32.10**. Its
...
The v0.32.10 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.32.10 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
