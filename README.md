...
The protected source and latest published release are **v0.34.25**. Release-assets workflow
[`32614440784`](https://github.com/0xPlayerOne/cortana/actions/runs/32614440784) published the
cross-platform package set for v0.34.25; the strict verifier passed all 18 assets, signatures,
checksums, manifest, and packaged-core/resource inspection. The v0.34.25 package carries the v0.34.5 runtime hardening,
...
The audited host installation now reports `cortana 0.34.25`. Embedding and HTTP services are
...
v0.34.22, v0.34.23, v0.34.24, and v0.34.25 change only release metadata or release-flow/UI
...
package for your operating system and CPU. The current protected release is **v0.34.25**. Its
...
The v0.34.25 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.34.25 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
