...
The protected source and latest published release are **v0.34.35**. Release Please PR #1928 is
...
The v0.34.35 package is a metadata-only follow-up to v0.34.34 and carries its verified runtime evidence and the approved-answer-term
...
contracts. The installed v0.34.35 binary passed the deterministic offline fixture evaluation and
...
package for your operating system and CPU. The current verified release is **v0.34.35**; its
...
The v0.34.35 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.34.35 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
