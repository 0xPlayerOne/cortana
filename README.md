...
The published v0.32.4 package is the latest downloadable release. It includes the production
...
Desktop sidecars publish atomically. Release-assets workflow `31867033998` completed all v0.32.4
...
package for your operating system and CPU. The current protected release is **v0.32.4**. The
