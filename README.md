...
The protected source and latest published release are **v0.34.6**. Release-assets workflow
`32531597016` completed all platform packages and the strict 18-asset verifier: all 18 release
assets, checksums, updater signatures, manifest, and packaged-core checks passed. The v0.34.6
...
The audited host installation now reports `cortana 0.34.6`, matching the latest published package.
...
package for your operating system and CPU. The current protected release is **v0.34.6**. Its
...
The v0.34.6 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.34.6 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
