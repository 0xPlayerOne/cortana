...
The protected source and latest published release are **v0.33.0**. Release-assets workflow
`31969571292` completed all platform packages and the strict 18-asset verifier: all 18 release
assets, checksums, updater signatures, manifest, and packaged-core checks passed. The v0.33.0
...
The last verified host installation reports `cortana 0.32.12`; the published v0.33.0 package is
...
package for your operating system and CPU. The current protected release is **v0.33.0**. Its
...
The v0.33.0 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.33.0 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
