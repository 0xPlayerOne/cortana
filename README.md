...
The protected source and latest published release are **v0.34.13**. Release-assets workflow
`32554817618` completed the platform-package and strict 18-asset verification gate. The v0.34.13
...
package for your operating system and CPU. The current protected release is **v0.34.13**. Its
...
The v0.34.13 Desktop support matrix is **macOS Apple Silicon (arm64), Linux x86_64, and Windows
x86_64**. v0.34.13 does not publish an Intel macOS Desktop bundle; Intel macOS is unsupported for
