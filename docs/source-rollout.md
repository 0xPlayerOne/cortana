...
| Google Drive/Gmail                                                         | All six configured sources now have bounded validation at 25 documents, 5 MiB, and 60 seconds. Work Drive and Work Gmail completed bounded no-reconcile syncs; the Personal Drive trial hit its 60-second embedding budget and is resumable. | Raise limits only source-by-source after reviewing the bounded result; production-budget validation is still required. |
