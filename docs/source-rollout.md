...
## Current operator state (2026-08-22; v0.34.13 release)
...
The published v0.34.13 release includes the bounded four-worker Drive body-fetch pool and regression
