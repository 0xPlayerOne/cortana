...
cleaned up and no index or reconciliation writes occurred. The staging tree now includes the
bounded four-worker body-fetch pool and regression coverage from PR #1594; install its resulting
