...
## Current operator state (2026-08-21; v0.34.1 release)
...
The latest Personal Drive bounded validation on 2026-08-21 failed closed before fetching because
the configured Google refresh token returned `invalid_grant`. Its configured production budget is
2,000 documents/128 MiB/900 seconds. An earlier 25-document/5 MiB/60-second sample succeeded,
but remains historical evidence. Work Drive completed its
...
| Google Drive/Gmail                                                         | Work Drive is complete at 478/4,527,721 bytes; Work Gmail is complete at 7,386/34,487,878 bytes; Personal Gmail is complete at 427/1,489,922 bytes; Special Gmail is complete at 216/1,004,868 bytes; Special Drive is complete at 97/290,353 bytes. Personal Drive's latest bounded validation failed closed with `invalid_grant`; an earlier 25-document/5 MiB/60-second sample remains historical against its 2,000-document/128 MiB/900-second budget. | Reauthorize Personal Drive through the explicit owner handoff, then rerun the bounded validation before any production-budget attempt; do not treat capped prefixes or failed runs as production snapshots. |
