...
The latest bounded source-smoke refresh replaced the local validation records for all 13 enabled
sources with fresh `complete=true` records capped at 25 documents, 5 MiB, and 60 seconds (sources
with fewer records naturally returned fewer documents). A follow-up live pass completed
validation-required, non-reconciling trials for every enabled non-code source: Apple Notes,
Drive, Gmail, Calendar, and Buzz. Every trial succeeded with zero deletions; Special Calendar
naturally returned zero records. These records support bounded, non-reconciling work only and
are below the configured production budgets; earlier larger production-budget results in this
plan are retained as historical evidence. Consequently the recurring sync service remains
uninstalled.

| Source                                                                     | Current evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Next action                                                                                                                                            |
| -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Apple Notes (`work-notes`, `personal-notes`, `special-notes`)              | Fresh bounded validation/trials: 25 `Nifty League` notes in `work`, 25 personal notes with the routed folders excluded, and 8 `The Pink Binder` notes in `special`; all completed with 0 deletions. The index still retains the earlier 28/65/8 snapshots.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Keep the exact folder filters; re-run only when a fresh snapshot is needed.                                                                            |
| Google Calendar (`work-calendar`, `personal-calendar`, `special-calendar`) | Fresh bounded validation/trials returned 25, 25, and 0 events respectively, all with 0 deletions. Earlier 2,208/1,839 production-budget validations remain historical evidence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Keep the trials non-reconciling; review status before increasing limits or enabling reconciliation.                                                    |
| Buzz                                                                       | Fresh bounded validation/trial returned 25 records with 0 deletions. The earlier 45-record run remains historical evidence.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Keep the source non-reconciling and re-run only after reviewing provider health.                                                                       |
| Google Drive/Gmail                                                         | Historical production-budget records exist for Work Drive (478 documents/4,527,663 bytes), Work Gmail (7,395/34,494,647), Personal Gmail (430/1,563,456), Special Drive (97/290,353), and Special Gmail (214/995,335). Bounded no-reconcile trials completed for Special Drive, Special Gmail (100-document cap), and Personal Gmail (100-document cap), with zero deletions; Work Drive also has a successful 100-document retry. Personal Drive failed its 2,000-document/128 MiB/900-second validation after the 899-second connector timeout, then passed a bounded 25-document/5 MiB/60-second validation and non-reconciling trial (`changed=1`, `unchanged=24`, `deleted=0`). The current on-disk records are the smaller bounded source-smoke snapshot described above. | Keep recurring sync disabled; continue one-source-at-a-time `--no-reconcile` trials and do not treat capped prefixes as complete production snapshots. |
