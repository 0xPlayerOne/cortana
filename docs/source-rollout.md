...
| Google Drive/Gmail                                                         | Authorized configuration exists, but current production-budget validation is missing.                                                                                                  | Validate one named source at a time, then run a bounded non-reconciling trial.                                 |
