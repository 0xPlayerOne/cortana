...
## Current operator state (2026-08-21; v0.34.6 release)
...
cleaned up and no index or reconciliation writes occurred. The protected v0.34.6 release includes the
