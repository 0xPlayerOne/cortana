...
## Current operator state (2026-08-23; v0.34.30 published and installed runtime)
...
The published v0.34.30 release boundary retains the bounded four-worker Drive body-fetch pool and regression
