...
| Apple Notes     | macOS Automation permission; no stored credential                                            | Executable/path checks, bounded filesystem-style validation, stable IDs, ACL propagation                                                   | Approve host Notes access, validate `personal-notes`, inspect status                          | Complete Notes validation at the intended full budget                                 |
