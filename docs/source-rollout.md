...
| Google Drive/Gmail                                                         | All six configured sources have bounded validation at 25 documents and 5 MiB. Work Drive, Work Gmail, and Personal Drive completed bounded no-reconcile syncs; the Personal Drive retry used a 300-second embedding budget and committed 25 documents with 0 deletions. | Raise limits only source-by-source after reviewing the bounded result; production-budget validation is still required. |
