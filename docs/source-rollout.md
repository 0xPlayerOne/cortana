...
| Google Drive/Gmail                                                         | Production-budget records for Work Drive (478 documents/4,527,663 bytes), Work Gmail (7,395/34,494,647), Personal Gmail (430/1,563,456), Special Drive (97/290,353), and Special Gmail (214/995,335). Bounded no-reconcile trials completed for Special Drive, Special Gmail (100-document cap), and Personal Gmail (100-document cap), with zero deletions; Work Drive also has a successful 100-document retry. Personal Drive failed its 2,000-document/128 MiB/900-second validation after the 899-second connector timeout, then passed a bounded 25-document/5 MiB/60-second validation and non-reconciling trial (`changed=1`, `unchanged=24`, `deleted=0`). | Keep recurring sync disabled; continue one-source-at-a-time `--no-reconcile` trials and do not treat capped prefixes as complete production snapshots. |
