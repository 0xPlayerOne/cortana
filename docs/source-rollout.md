...
## Current operator state (2026-08-22; v0.34.12 release)
...
The installed v0.34.12 release includes the bounded four-worker Drive body-fetch pool and regression
