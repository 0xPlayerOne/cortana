...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.32.9`, with release-assets workflow `31920097809` completing all 18 assets, signatures, manifest, and packaged-core verification              |
| Source checkout                | Tracks the protected v0.32.9 tree; the tagged release and strict verifier are the end-user package evidence boundary                              |
