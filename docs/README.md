...
| ------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.32`; release-assets workflow `32648129839` and the strict verifier passed all 18 assets, signatures, checksums, manifest, and packaged core |
