...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.13`, with release-assets workflow `32554817618` active for the 18-asset signature, manifest, and packaged-core gate                        |
| Source checkout                | Tracks the protected v0.34.13 tree; the tag is published and asset verification is recorded in the release history                                |
