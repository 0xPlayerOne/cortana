...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.22`; release-assets workflow `32606500860` verified all 18 assets, signatures, manifest, and packaged core                                 |
| Source checkout                | Tracks the protected v0.34.22 tree; the tag is published and the strict verifier passed                                                           |
