...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.0`, with release-assets workflow `31975576411` verified: 18 assets, signatures, manifest, and packaged core                                |
| Source checkout                | Tracks the protected v0.34.0 tree; the tag is published and the strict verifier passed                                                            |
