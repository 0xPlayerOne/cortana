...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.19`, with release-assets workflow `32601930711` verifying 18 assets, signatures, manifest, and packaged core                               |
| Source checkout                | Tracks the protected v0.34.19 tree; the tag is published and the strict verifier passed                                                           |
