...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.16`, with release-assets workflow `32589317192` as the current 18-asset verification gate                                                     |
| Source checkout                | Tracks the protected v0.34.16 tree; the tag is published and asset verification is recorded in the release page                                      |
