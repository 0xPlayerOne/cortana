...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Downloadable package           | `v0.34.21`; release-assets workflow `32605080974` is publishing the 18-asset signature/manifest/package gate; strict verification remains pending |
| Source checkout                | Tracks the protected v0.34.21 tree; the tag is published and the strict verifier is pending                                                       |
