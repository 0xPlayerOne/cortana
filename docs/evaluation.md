...
spool was cleaned up and no index or reconciliation writes occurred. The protected main tree now includes
bounded parallel body fetching from PR #1594; install the next patch release before repeating that
