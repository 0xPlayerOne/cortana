...
latest installed v0.29.56 core binary rerun passed the same fixture-only evaluator in 17,728 ms;
the published v0.29.57 core archive also passed headlessly in 15,438 ms. Both runs had
