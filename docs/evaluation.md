...
workflow `31578434124` is still running; the previous v0.31.5 workflow
`31575709770` completed all platform jobs plus the strict 18-asset verifier.
The installed CLI reports `v0.31.5`;
...
evaluation passed in 12,250 ms (earlier verified runs passed in 13,871 ms,
19,524 ms, 15,774 ms, and 13,237 ms) with planner and synthesis model use, valid citations, cache reuse,
