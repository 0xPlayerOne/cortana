...
least one backup location available. The v0.34.32 release-assets and 18-asset package-integrity
...
1. **Download Cortana Desktop.** Open the [latest GitHub release](https://github.com/0xPlayerOne/cortana/releases/latest)
   ...
   **v0.34.32**; [Release history](releases.md) records its verifier state and historical patches.
