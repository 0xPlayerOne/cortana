...
- The installed v0.34.7 host passed the bounded provider-backed `eval --model` evidence run on
  2026-08-21 with 14,189 ms answer latency: retrieval recall, MRR, case pass rate, citation validity,
...
2. Model-backed provider gate: the verified v0.34.7 package passed the credential-free packaged-core
   ...
   the bounded provider-backed run on 2026-08-21 with 14,189 ms answer latency, planner/synthesis, valid
