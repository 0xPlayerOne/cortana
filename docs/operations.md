...
workflow `31476791815` is historical evidence. The current v0.30.6 release-assets workflow
`31490251675` completed all five platform jobs; the strict
...
now reports v0.30.6; the packaged Desktop GUI has not been launched or replaced on this host. The
