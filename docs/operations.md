...
workflow `31476791815` is historical evidence. The current v0.30.7 release-assets workflow
`31504888587` completed all five platform jobs; the strict
...
now reports v0.30.7; the packaged Desktop GUI has not been launched or replaced on this host. The
