...
Published v0.29.44 has 18 release assets; release-assets run `31392960117` completed successfully
...
core archive extracted from the published v0.29.44 release reports `cortana 0.29.44`.
The current installed packaged Desktop app at `/Applications/Cortana.app` reports v0.29.43; its
...
```bash
GH_REPO=0xPlayerOne/cortana CORTANA_REQUIRE_MINISIGN=1 scripts/verify-desktop-release.sh v0.29.44
```
