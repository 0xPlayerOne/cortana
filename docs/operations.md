...
Published v0.29.45 has 18 release assets; release-assets run `31394028819` completed successfully
...
core archive extracted from the published v0.29.45 release reports `cortana 0.29.45`.
...
```bash
GH_REPO=0xPlayerOne/cortana CORTANA_REQUIRE_MINISIGN=1 scripts/verify-desktop-release.sh v0.29.45
```
