...
reconciliation writes occurred. PR #1594 adds bounded parallel body fetching and must be promoted
before repeating the production-budget gate. `readiness --allow-sync-service` therefore remains
