...
verifier is the final gate for all 18 assets, archive checksums, updater signatures, the updater
manifest, and packaged-core/resource inspection; published Linux binary execution is skipped on
non-Linux hosts.
