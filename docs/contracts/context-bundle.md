...
| `metrics`                    | object       | Retrieved/included/omitted counts, token estimate, and bounded context-reduction metrics |
...
| `retrieval_contract_version` | string       | `cortana.retrieval.v2`                                                                   |
