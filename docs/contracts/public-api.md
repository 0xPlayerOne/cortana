...
| Code symbol lookup       | `POST /v1/code/symbols`                                                              | `lookup_symbol`                                                                  | —                                      | exact, revision-aware symbol hits          |
| Code relation page       | `GET /v1/code/relations`                                                             | `code_relations`                                                                 | —                                      | bounded neighborhood/call/impact page      |
| Knowledge graph page     | `GET /v1/graph`                                                                      | —                                                                                | —                                      | [versioned graph page](knowledge-graph.md) |
| Memory recall            | `POST /v1/memory/recall`                                                             | `memory_recall`                                                                  | `memory recall --json`                 | scoped memory records                      |
| Memory candidate         | `POST/GET /v1/memory/candidates`, `GET .../export`                                   | `propose_memory_candidate`, `list_memory_candidates`, `export_memory_candidates` | `memory candidate propose/list/export` | bounded page + explicit truncation         |
