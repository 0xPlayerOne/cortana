...
The published `v0.34.41` tag is the current source/release boundary. Release-assets workflow
`32678200301` published all supported platform assets; the strict cross-platform verifier passed
