...
The published `v0.34.12` tag is the current source/release boundary. Its release-assets workflow
`32552400854` completed the strict 18-asset verifier, including checksums, updater signatures,
