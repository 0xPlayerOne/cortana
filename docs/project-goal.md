...
The published `v0.34.13` tag is the current source/release boundary. Its release-assets workflow
`32554817618` completed the strict 18-asset verifier, including checksums, updater signatures,
