...
The published `v0.34.10` tag is the current source/release boundary. Its release-assets workflow
`32544658079` completed the strict 18-asset verifier, including checksums, updater signatures,
