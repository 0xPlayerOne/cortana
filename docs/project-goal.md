...
The published `v0.34.3` tag is the current source/release boundary. Its release-assets workflow
`32516622075` completed the strict 18-asset verifier, including checksums, updater signatures,
