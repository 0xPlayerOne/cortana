...
The published `v0.34.2` tag is the current source/release boundary. Its release-assets workflow
`32500872377` completed the strict 18-asset verifier, including checksums, updater signatures,
