...
The published `v0.34.17` tag is the current source/release boundary. Its release-assets workflow
`32593385885` completed the strict 18-asset verifier, including checksums, updater signatures,
