...
The published `v0.34.25` tag is the current source/release boundary. Its release-assets workflow
(`32614440784`) published the cross-platform package set; the strict 18-asset verifier passed all
