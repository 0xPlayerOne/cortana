...
The published `v0.34.23` tag is the current source/release boundary. Its release-assets workflow
is publishing the strict 18-asset verifier (`32608361505`), including checksums, updater signatures,
