...
The published `v0.32.8` tag is the current source/release boundary and its release-assets workflow
`31903165576` passed the strict 18-asset verifier. A source checkout can contain validated changes
