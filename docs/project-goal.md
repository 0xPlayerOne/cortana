...
The published `v0.34.5` tag is the current source/release boundary. Its release-assets workflow
`32528987169` completed the strict 18-asset verifier, including checksums, updater signatures,
