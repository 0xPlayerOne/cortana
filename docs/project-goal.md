...
The published `v0.34.4` tag is the current source/release boundary. Its release-assets workflow
`32525494727` completed the strict 18-asset verifier, including checksums, updater signatures,
