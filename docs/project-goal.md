...
The published `v0.34.9` tag is the current source/release boundary. Its release-assets workflow
`32540177167` completed the strict 18-asset verifier, including checksums, updater signatures,
