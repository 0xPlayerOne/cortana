...
The published `v0.34.14` tag is the current source/release boundary. Its release-assets workflow
`32560090908` completed the strict 18-asset verifier, including checksums, updater signatures,
