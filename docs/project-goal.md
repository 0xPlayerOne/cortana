...
The published `v0.34.0` tag is the current source/release boundary. Its release-assets workflow
`31975576411` completed the strict 18-asset verifier, including checksums, updater signatures,
