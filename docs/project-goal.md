...
The published `v0.34.7` tag is the current source/release boundary. Its release-assets workflow
`32533269847` completed the strict 18-asset verifier, including checksums, updater signatures,
