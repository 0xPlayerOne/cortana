...
The published `v0.33.0` tag is the current source/release boundary. Its release-assets workflow
`31969571292` completed the strict 18-asset verifier, including checksums, updater signatures,
