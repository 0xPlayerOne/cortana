...
The published `v0.34.22` tag is the current source/release boundary. Its release-assets workflow
completed the strict 18-asset verifier (`32606500860`), including checksums, updater signatures,
