...
The published `v0.34.6` tag is the current source/release boundary. Its release-assets workflow
`32531597016` completed the strict 18-asset verifier, including checksums, updater signatures,
