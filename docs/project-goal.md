...
The published `v0.34.11` tag is the current source/release boundary. Its release-assets workflow
`32546628726` completed the strict 18-asset verifier, including checksums, updater signatures,
