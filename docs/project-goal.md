...
The published `v0.34.21` tag is the current source/release boundary. Its release-assets workflow
is publishing the strict 18-asset verifier (`32605080974`), including checksums, updater signatures,
