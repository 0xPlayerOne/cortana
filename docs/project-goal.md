...
The published `v0.34.1` tag is the current source/release boundary. Its release-assets workflow
`32343629811` completed the strict 18-asset verifier, including checksums, updater signatures,
