...
The published `v0.32.9` tag is the current source/release boundary and its release-assets workflow
`31920097809` passed the strict 18-asset verifier. A source checkout can contain validated changes
