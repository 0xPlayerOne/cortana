...
The published `v0.34.40` tag is the current source/release boundary. Release-assets workflow
`32675543606` published all supported platform assets and the strict cross-platform verifier passed
