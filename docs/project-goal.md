...
The published `v0.32.10` tag is the current source/release boundary and its release-assets workflow
`31926397636` passed the strict 18-asset verifier. A source checkout can contain validated changes
