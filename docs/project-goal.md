...
The published `v0.34.16` tag is the current source/release boundary. Its release-assets workflow
`32589317192` completed the strict 18-asset verifier, including checksums, updater signatures,
