...
The published `v0.34.36` tag is the current source/release boundary. Release-assets workflow
`32659532068` published all supported platform assets and the strict cross-platform verifier passed
